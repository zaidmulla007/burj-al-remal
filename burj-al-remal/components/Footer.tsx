...
const Footer = () => {
  ...
  return (
    <footer className="bg-zinc-950 border-t border-red-600/20 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold text-red-600 mb-4">BURJ AL REMAL</h3>
              ...
              <li>
                <Link href="/">
                  <motion.span
                    ...
                    className="text-gray-400 hover:text-red-600 transition-all cursor-pointer inline-block"
                  >
                    Home
                  </motion.span>
                </Link>
            ...
            <ul className="space-y-2">
              {productCategories.map((category) => (
                <li key={category}>
                  <motion.span
                    whileHover={{ x: 5, color: '#E31E24' }}
                    className="text-gray-400 hover:text-red-600 transition-all cursor-pointer inline-block text-sm"
                  >
                    {category}
                  </motion.span>
                </li>
