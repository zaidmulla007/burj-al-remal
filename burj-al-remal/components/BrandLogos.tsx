    ...
    <section className="py-20 bg-zinc-950 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-12 hidden lg:block">
            ...
            >
              {[...brands, ...brands].map((brand, index) => (
                <motion.div
                  ...
                  className="flex-shrink-0 bg-white rounded-xl p-6 w-48 h-32 flex items-center justify-center cursor-pointer transition-all shadow-lg hover:shadow-red-600/20"
                >
          ...
          {/* Gradient Overlays */}
          <div className="absolute top-0 left-0 w-32 h-full bg-gradient-to-r from-zinc-950 to-transparent pointer-events-none z-10" />
          <div className="absolute top-0 right-0 w-32 h-full bg-gradient-to-l from-zinc-950 to-transparent pointer-events-none z-10" />
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {brands.map((brand, index) => (
            <motion.div
              ...
              className="bg-white rounded-xl p-4 transition-all cursor-pointer shadow-md hover:shadow-xl hover:shadow-red-600/20 h-28 flex items-center justify-center"
            >
              <div className="relative w-full h-full">
                <Image
                  src={brand.image}
